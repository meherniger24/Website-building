...
PROJECT_PAGES = {
  ...
  'pub2': Project(
    ...
    image_caption = 'Whole brain vasculature imaged using knife edge scanning microscopy (KESM) and available online (kesm.cs.tamu.edu)(a) Reconstruction from 140 slices across the whole brain is shown, along with (b) a 4000&times;2000&times;2000 voxel sub-volume with (c-e) several iterated higher-resolution zooms.',
